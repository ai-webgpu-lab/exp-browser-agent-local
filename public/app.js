const metadata = Object.freeze({
  ...
  category: "agent",
  purpose: "브라우저 agent baseline",
  priority: "P2",
  trackLabel: "Agent",
  kindLabel: "experiment",
  trackSlug: "agent",
  workloadKind: "agent",
  pagesUrl: "https://ai-webgpu-lab.github.io/exp-browser-agent-local/",
  repoUrl: "https://github.com/ai-webgpu-lab/exp-browser-agent-local",
  readmeUrl: "https://github.com/ai-webgpu-lab/exp-browser-agent-local/blob/main/README.md",
  resultsUrl: "https://github.com/ai-webgpu-lab/exp-browser-agent-local/blob/main/RESULTS.md"
});
